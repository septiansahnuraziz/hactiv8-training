...
type TodosClient interface {
	CreateTodo(ctx context.Context, in *Todo, opts ...grpc.CallOption) (*MutationResponse, error)
...
func (c *todosClient) CreateTodo(ctx context.Context, in *Todo, opts ...grpc.CallOption) (*MutationResponse, error) {
	out := new(MutationResponse)
	err := c.cc.Invoke(ctx, "/Todos/CreateTodo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todosClient) List(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*TodoList, error) {
	out := new(TodoList)
	err := c.cc.Invoke(ctx, "/Todos/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todosClient) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*MutationResponse, error) {
	out := new(MutationResponse)
	err := c.cc.Invoke(ctx, "/Todos/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todosClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*MutationResponse, error) {
	out := new(MutationResponse)
	err := c.cc.Invoke(ctx, "/Todos/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TodosServer interface {
	CreateTodo(context.Context, *Todo) (*MutationResponse, error)
...
func (UnimplementedTodosServer) CreateTodo(context.Context, *Todo) (*MutationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateTodo not implemented")
}
func (UnimplementedTodosServer) List(context.Context, *empty.Empty) (*TodoList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method List not implemented")
}
func (UnimplementedTodosServer) Update(context.Context, *UpdateRequest) (*MutationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedTodosServer) Delete(context.Context, *DeleteRequest) (*MutationResponse, error) {
